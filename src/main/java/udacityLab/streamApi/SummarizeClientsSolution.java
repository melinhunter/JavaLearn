...
/**
 * https://www.youtube.com/watch?time_continue=4&v=BV9F8zZvc3k&feature=emb_logo
 * https://www.youtube.com/watch?v=BV9F8zZvc3k&t=4s
 */
public class SummarizeClientsSolution {
    public static void main(String[] args) {
        ...
        Map<Year, Long> contractsPerYear =
                clients
                        .stream()
                        .collect(Collectors.groupingBy(SummarizeClientsSolution::getContractYear, Collectors.counting()));
